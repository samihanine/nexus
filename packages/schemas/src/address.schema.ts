...
export const addressApi = apiBuilder()
  .addEndpoint({
    ...
    response: z.array(addressSchema.omit({ id: true, createdAt: true, updatedAt: true, deletedAt: true })),
    parameters: [
      {
        name: "query",
        type: "Query",
    ...
    parameters: [
      {
        name: "address",
        type: "Body",
        schema: addressSchema.omit({ id: true, createdAt: true, updatedAt: true, deletedAt: true }),
      },
    ],
    errors: [
      {
