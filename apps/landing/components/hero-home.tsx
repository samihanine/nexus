...
export default function HeroHome() {
  return (
    <section className="pt-32 sm:pt-36 md:pt-40 lg:pt-36" id="home">
      <div className="mx-auto px-4 sm:px-12 xl:max-w-6xl xl:px-0">
        <div className="text-center">
          <div className="items-center gap-12 lg:flex">
            <div className="md:mx-auto md:w-3/4 lg:ml-0 lg:w-1/2">
              <h1 className="text-center text-4xl font-bold text-gray-900 dark:text-white sm:text-5xl lg:text-left lg:text-6xl">
                Immovia,
                <br /> la plateforme qui connecte
                <span className="relative">
                  <svg
                    fill="currentColor"
                    className="absolute text-primary inset-x-0 -bottom-1 w-full opacity-50"
